...
%\documentclass[kclharvardbib]{kclthesis}  
% notes see below
	% {kclthesis} final version 
	% [isdraft]{kclthesis} provides background water mark "DRAFT"
	% [kclharvardbib]{kclthesis} provides different reference style.
...
\author{John Doe}
\modulecode{ModuleCode: 7CCSMPRJ}
